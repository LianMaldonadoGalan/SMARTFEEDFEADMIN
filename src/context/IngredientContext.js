...
const patchIngredient = dispatch => async (id, name, picture) => {
    await smartFeed.patch('/ingredients/'+id, {name, picture});
}
  
export const { Provider, Context } = createDataContext(
  ingredientReducer,
  { fetchIngredients, createIngredient, getIngredient, deleteIngredient, patchIngredient },
  [], 
);